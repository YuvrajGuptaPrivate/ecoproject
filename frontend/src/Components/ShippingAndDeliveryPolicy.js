...
const ShippingAndDeliveryPolicy = () => {
  return (
    <div className="terms-and-conditions">
      ...
      <p>
        Neelkanth Traders is not liable for any delay in delivery by the courier company / postal authorities and only guarantees to hand over the consignment to the courier company or postal authorities within 0-7 days from the date of the order and payment or as per the delivery date agreed at the time of order confirmation.
      </p>
      <p>
      ...
      <p>
        For any issues in utilizing our services you may contact our helpdesk on 9811623065.
      </p>
    </div>
  );
};
